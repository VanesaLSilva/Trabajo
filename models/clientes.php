...
class Cliente extends Conexion {
    ...
    {
        $this->conectar();
        $pre = mysqli_prepare($this->con, "UPDATE cliente SET id_almacen = ?, nombre = ?, apellidos = ?, email = ?, id_direccion = ?, activo = ? WHERE id_cliente = ?");
        $pre->bind_param("issssii", $this->id_almacen, $this->nombre, $this->apellidos, $this->email, $this->id_direccion, $this->activo, $this->id_cliente);
        $pre->execute();
    }
